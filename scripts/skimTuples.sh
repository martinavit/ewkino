...
cd $baseFolder
folderTestmu=HeavyNeutrino_trilepton_M-1_*mu_massiveAndCKM_LO*/*17*displaced_signals_v4
folderTeste=HeavyNeutrino_trilepton_M-1_*e_massiveAndCKM_LO*/*17*displaced_signals_v4

...
void treeReader::initTree(TTree *tree, const bool isData, const bool Is2016)
{
   ...
   if (!Is2016)fChain->SetBranchAddress("_HHLT_Ele32_WPTight_Gsf_L1DoubleEG", &_HLT_Ele32_WPTight_Gsf_L1DoubleEG, &b__HLT_Ele32_WPTight_Gsf_L1DoubleEG);
   ...
   fChain->SetBranchAddress("_lElectronMvaSummer16GP", _lElectronMvaSummer16GP, &b__lElectronMvaSummer16GP);
   fChain->SetBranchAddress("_lElectronMvaSummer16HZZ", _lElectronMvaSummer16HZZ, &b__lElectronMvaSummer16HZZ);
